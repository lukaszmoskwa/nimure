    ...
    finder = finders.new_table({
      ...
      entry_maker = function(resource)
        ...
        return {
          ...
          ordinal = resource.name .. " " .. resource.type .. " " .. resource.resource_group .. " " .. resource.location,
        }
      end
    }),
  ...
  return previewers.new_buffer_previewer({
    ...
    define_preview = function(self, entry, status)
      ...
      if resource.kind then
        table.insert(lines, "Kind: " .. resource.kind)
      end
      
      if resource.sku then
        table.insert(lines, "SKU: " .. vim.inspect(resource.sku))
      end
      
      table.insert(lines, "")
      table.insert(lines, "Actions:")
      table.insert(lines, "  <Enter> - Show detailed information")
      table.insert(lines, "  <C-y>   - Copy resource ID")
      table.insert(lines, "  <C-n>   - Copy resource name")
      table.insert(lines, "  <C-m>   - Show metrics")
